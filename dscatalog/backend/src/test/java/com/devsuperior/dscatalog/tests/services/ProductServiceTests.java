...
public class ProductServiceTests {
	...
	void setUp() {
		...
		Mockito.when(repository.findCustom(ArgumentMatchers.any(), ArgumentMatchers.anyString(), ArgumentMatchers.any())).thenReturn(page);
	...
	public void findAllPagedShouldReturnPage() {
		...
		Mockito.verify(repository, Mockito.times(1)).findCustom(null, name, pageRequest);
	}
